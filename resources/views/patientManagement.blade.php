...
@section('content')
<div style="max-width: 1000px; margin: 0 auto; padding: 2rem; background-color: rgb(17, 24, 39); border-radius: 8px;">
        ...
        <div style="overflow-x: auto; background-color: #333; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            <table style="width: 100%; border-collapse: collapse;">
                <thead style="background-color: rgb(25, 35, 50); color: #F5F5F5;">
                    <tr>
                        <th style="padding: 1rem; text-align: left; width: 20%;">Patient Name</th>
                        <th style="padding: 1rem; text-align: left; width: 15%; white-space: nowrap;">Birth Date</th>
                        <th style="padding: 1rem; text-align: left; width: 10%;">Gender</th>
                        <th style="padding: 1rem; text-align: left; width: 20%;">Contact Number</th>
                        <th style="padding: 1rem; text-align: left; width: 20%;">Email</th>
                        <th style="padding: 1rem; text-align: left; width: 15%;">Actions</th>
                    </tr>
                </thead>
                <tbody style="background-color: rgb(31, 41, 55); color: #F5F5F5;">
                    @foreach($patients as $patient)
                        <tr>
                            ...
                            <td style="padding: 1rem; white-space: nowrap;">{{ $patient->birth_date }}</td>
